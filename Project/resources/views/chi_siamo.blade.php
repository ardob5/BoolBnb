...
<div class="main_content" id="content-bnb">
    <div class="container">
        <div class="row justify-content-center mt-5">
          <div class="col-md-6 col-lg-6 d-flex justify-content-center align-items-center flex-column col-scale">
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-lg-4 col-md-4 d-flex justify-content-center align-items-center flex-column col-scale">
            ...
            <div class="col-md-4 col-lg-4 d-flex justify-content-center align-items-center flex-column col-scale">
            ...
            <div class="col-lg-4 col-md-12 d-flex justify-content-center align-items-center flex-column col-scale">
